...
export default function CustomerSidebar() { // Renamed component
  ...
  const navItems = [
    ...
    { icon: Star, label: "Reviews Given", path: "/customer-reviews" }, // Updated label to "Reviews Given"
    ...
    <>
        ...
        <Box p={3}>
          ...
          <Box mt={2} display="flex" width="100%" justifyContent="space-between">
            ...
            <Tooltip title="Settings">
              <ActionIcon onClick={() => navigate('/profile')}> {/* Changed from /settings to /profile */}
                <Settings size={20} />
              </ActionIcon>
            </Tooltip>
      ...
      >
        <MenuItem onClick={() => {setProfileAnchor(null); navigate('/profile');}}>
         ...
         <MenuItem onClick={() => {setProfileAnchor(null); navigate('/profile');}}> {/* Changed from /settings to /profile */}
